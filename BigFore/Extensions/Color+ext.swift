   ...
   //  howFar Watch App
   //
   //  Created by Grant Perry on 5/16/26
   //
...
extension Color {
   ...
   static let gpTripleBogey = Color(#colorLiteral(red: 0.5568627715, green: 0.3529411852, blue: 0.9686274529, alpha: 1))
   static let gpDoubleBogey = Color(#colorLiteral(red: 1, green: 0.1491314173, blue: 0, alpha: 1))
   static let gpBogey = Color(#colorLiteral(red: 0.9686274529, green: 0.78039217, blue: 0.3450980484, alpha: 1))
   static let gpPar = Color(#colorLiteral(red: 0.4666666687, green: 0.7647058964, blue: 0.2666666806, alpha: 1))
   static let gpBirdie = Color(#colorLiteral(red: 0.1764705926, green: 0.4980392158, blue: 0.7568627596, alpha: 1))
   static let gpEagle = Color(#colorLiteral(red: 0.8549019694, green: 0.250980407, blue: 0.4784313738, alpha: 1))
   static let gpAlbatross = Color(#colorLiteral(red: 0.5808190107, green: 0.0884276256, blue: 0.3186392188, alpha: 1))
   ...
   static let gpYellow = Color(#colorLiteral(red: 0.9764705896, green: 0.850980401, blue: 0.5490196347, alpha: 1))
	  /// Yellow-green; complements blue-violet on the wheel (#7FFF00 family).
   static let gpChartreuse = Color(#colorLiteral(red: 0.4980392157, green: 1, blue: 0, alpha: 1))
   ...
   static let gpManagerChallenge = Color(#colorLiteral(red: 0.2392156869, green: 0.6745098233, blue: 0.9686274529, alpha: 1))
   ...
   static let gpDouble = Color(#colorLiteral(red: 0.4865041375, green: 0.3282584548, blue: 0.4658794403, alpha: 1))
   static let gpTriple = Color(#colorLiteral(red: 0.8549019694, green: 0.250980407, blue: 0.4784313738, alpha: 1))
   static let gpHomer = Color(#colorLiteral(red: 0.5843137503, green: 0.8235294223, blue: 0.4196078479, alpha: 1))
   static let gpOverturned = Color(#colorLiteral(red: 0.996009171, green: 0, blue: 0.2860964239, alpha: 1))


	  /// Run-scoring pill and border colors for recap (bottom half = home, top = away). Assign at launch to theme app-wide.
   enum GameRun {
	  static var homeRunColor: Color = .gpYellow
	  static var awayRunColor: Color = .gpChartreuse

	  static func accent(isAwayHalf: Bool) -> Color {
		 isAwayHalf ? awayRunColor : homeRunColor
	  }
   }
